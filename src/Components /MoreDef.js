...
info
    ...
    <Modal show={show} onHide={handleClose} centered className='modalbackground '>
          <Modal.Header closeButton className='modalbackgroundcolor modaltitle '> {roms ? words.words[0].hits[0].roms[0].headword : words.words[0].hits[0].target
          ...
          <Modal.Body className='modalbackgroundcolor modaltext'>
            ...
            {roms ? <div dangerouslySetInnerHTML={{ __html: replaceWithBr() }}
